...
fn test_x86_filter_each_attribute() {
    let ranges = vec![
        X86PageRange::new(0x10000, 0x10000, 
            PageAttributes {
                accessed: false,
                dirty: false,
                writeable: false,
        ...
        X86PageRange::new(0x30000, 0x10000, 
            PageAttributes {
                accessed: false,
                dirty: false,
                writeable: true,
        ...
        X86PageRange::new(0x90000, 0x10000, 
            PageAttributes {
                accessed: false,
                dirty: false,
                writeable: false,
        ...
        X86PageRange::new(0xb0000, 0x10000, 
            PageAttributes {
                accessed: false,
                dirty: false,
                writeable: true,
...
fn test_x86_filter_has_address() {
    ...
    let ranges = vec![
        ...
        X86PageRange::new(0x20000, 0x1000, 
            attr.clone(),
            Vec::<PhysRange>::new()
        ),
        X86PageRange::new(0x21000, 0xa0000, 
            attr.clone(),
            Vec::<PhysRange>::new()
        ),
        X86PageRange::new(0xaaa0000, 0x2000, 
            attr.clone(),
            Vec::<PhysRange>::new()
        )
    ];
    ...
    let tests = [(0x1000, ranges.len()), (0x10000, 0), (0x1ffff, 0), (0x20000, 1), (0x20500, 1), (0x20fff, 1), (0xaaa0000, 3), (0xaaa1fff, 3), (0xaaa2000, ranges.len())];
    let mut filter = PageRangeFilterX86::new();
